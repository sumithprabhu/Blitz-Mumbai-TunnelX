...
export function Navbar() {
  ...
  // Only show wallet functionality on connect and dashboard routes
  const showWallet = pathname === "/connect" || pathname === "/dashboard"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2">
            <div className="text-2xl font-bold bg-secondary  bg-clip-text text-transparent">
              TunnelX
            </div>
          </Link>
          ...
          <div className="flex items-center gap-4">
            {/* Wallet Button - Only show on connect and dashboard routes */}
            {showWallet && (
